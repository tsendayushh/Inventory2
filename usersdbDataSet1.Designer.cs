...
namespace Treasurer2 {
    ...
    public partial class usersdbDataSet1 : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public productRow AddproductRow(string pname, string ptype, System.DateTime date_manufactured, System.DateTime date_expire, string person_responsible_for, byte[] image, int price, int stock_quantity, int quantity) {
...
namespace Treasurer2.usersdbDataSet1TableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `product` (`pname`, `ptype`, `date_manufactured`, `date_expire`, `per" +
                "son_responsible_for`, `image`, `price`, `stock_quantity`, `quantity`) VALUES (@p" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `product` SET `pname` = @p1, `ptype` = @p2, `date_manufactured` = @p3, `date_expire` = @p4, `person_responsible_for` = @p5, `image` = @p6, `price` = @p7, `stock_quantity` = @p8, `quantity` = @p9 WHERE ((`product_id` = @p10) AND ((@p11 = 1 AND `pname` IS NULL) OR (`pname` = @p12)) AND ((@p13 = 1 AND `ptype` IS NULL) OR (`ptype` = @p14)) AND ((@p15 = 1 AND `date_manufactured` IS NULL) OR (`date_manufactured` = @p16)) AND ((@p17 = 1 AND `date_expire` IS NULL) OR (`date_expire` = @p18)) AND ((@p19 = 1 AND `person_responsible_for` IS NULL) OR (`person_responsible_for` = @p20)) AND ((@p21 = 1 AND `price` IS NULL) OR (`price` = @p22)) AND ((@p23 = 1 AND `stock_quantity` IS NULL) OR (`stock_quantity` = @p24)) AND ((@p25 = 1 AND `quantity` IS NULL) OR (`quantity` = @p26)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `product_id`, `pname`, `ptype`, `date_manufactured`, `date_expire`, `perso" +
                "n_responsible_for`, `image`, `price`, `stock_quantity`, `quantity` FROM `product" +
                "`";
        ...
        public virtual int Fill(usersdbDataSet1.productDataTable dataTable) {
        ...
        public virtual usersdbDataSet1.productDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            usersdbDataSet1.productDataTable dataTable = new usersdbDataSet1.productDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(usersdbDataSet1.productDataTable dataTable) {
